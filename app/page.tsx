      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 w-full">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 md:px-8 text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 bg-gradient-to-r from-orange-500/10 to-pink-500/10 border border-orange-500/30 rounded-full backdrop-blur-xl">
            ...
            <span className="text-sm font-semibold text-orange-300">Limpieza Profesional 2025</span>
          </div>
          ...
          <div className="flex justify-center gap-3 mb-12 flex-wrap">
            <div className="px-4 py-2 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 rounded-full text-green-300 font-semibold text-sm backdrop-blur">
              ✓ Rápido
            </div>
            <div className="px-4 py-2 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-full text-blue-300 font-semibold text-sm backdrop-blur">
              ✓ Seguro
            </div>
            <div className="px-4 py-2 bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-full text-purple-300 font-semibold text-sm backdrop-blur">
              ✓ Fácil
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 md:gap-8 max-w-xl mx-auto">
            <div className="p-4 rounded-lg bg-gradient-to-br from-green-600/20 to-emerald-600/20 border border-green-500/30 backdrop-blur hover:scale-110 transition-transform">
            ...
            <div className="p-4 rounded-lg bg-gradient-to-br from-blue-600/20 to-cyan-600/20 border border-blue-500/30 backdrop-blur hover:scale-110 transition-transform">
              <div className="text-3xl font-black bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent flex items-center justify-center gap-1">
                4.9 <Star className="w-5 h-5 fill-blue-400" />
              </div>
              <p className="text-xs text-gray-400 mt-1">Rating</p>
            </div>
            <div className="p-4 rounded-lg bg-gradient-to-br from-purple-600/20 to-pink-600/20 border border-purple-500/30 backdrop-blur hover:scale-110 transition-transform">
        ...
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className={`relative group p-8 rounded-3xl border-2 backdrop-blur transition-all transform hover:scale-105 ${
                  plan.popular 
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
                    <div className={`bg-gradient-to-r ${plan.color} text-white px-4 py-1 rounded-full text-sm font-bold flex items-center gap-1`}>
                      ⭐ MÁS POPULAR
                    </div>
                  </div>
                )}
